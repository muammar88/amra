...
function add_aktualisasi(paket_id){
   ajax_x_t2(
   ...
   var form = `<tr style="background-color: #f1f5fd;">
         ...
         if( status == 'buka' ){
            form += `<button class="btn btn-default btn-action" title="Tambah uraian aktualisasi anggaran"
                         onclick="add_aktualisasi(${paket_id})">
...
function detailAktualisasiBtn(detail_aktualisasi_id, label, unit, value, status){
   var form = `<tr>
                  ...
                  <td class="text-left" colspan="2" style="vertical-align: middle;width:36%;"></td>
                  <td class="text-right" style="width:13%;vertical-align: middle;">${value}</td>
                  <td style="width:15%;vertical-align: middle;">`;
      if( status == 'buka' ) {
                     ...
                     <table class="table table-hover">
                        <thead>
                           <tr>
                              ...
                              <th style="width:30%;">Kontak  Agen</th>
...
function ListDaftarAgenPaket(JSONData){
   ...
   var form = `<tr ${ status_paket == 'tutup' ? 'class="tabletutup"': '' }>
                  <td><b>${json["fullname"]}</b> <br>(No Identitas : ${json["identity_number"]})</td>
                  <td>
                     <table class="table table-hover my-1">
                        <tbody>
                           <tr>
                              <td style="width:30%; border-bottom:none;" class="pt-0 px-0 text-left"><b>Level Agen</b></td>
                              <td style="width:1%;border-bottom:none;" class="pt-0 pl-0">:</td>
                              <td style="width:69%;border-bottom:none;text-transform:uppercase;" class="pt-0 px-0 text-left">${json['level_agen']}</td>
                           </tr>
                           <tr>
                              <td style="width:30%; border-bottom:none;" class="pt-0 px-0 text-left"><b>No HP</b></td>
                              <td style="width:1%;border-bottom:none;" class="pt-0 pl-0">:</td>
                              <td style="width:69%;border-bottom:none;" class="pt-0 px-0 text-left">${json['nomor_whatsapp']}</td>
                           </tr>
                           <tr>
                              <td style="width:30%; border-bottom:none;" class="pt-0 px-0 text-left"><b>Alamat</b></td>
                              <td style="width:1%;border-bottom:none;" class="pt-0 pl-0">:</td>
                              <td style="width:69%;border-bottom:none;" class="pt-0 px-0 text-left">${json['address']}</td>
                           </tr>
                        </tbody>
                     </table>
                  </td>
            ...
            for( x in json['jamaah'] ) {
               form += `<li>${json['jamaah'][x]['name']} (${json['jamaah'][x]['identity_number']}) <br> <b>${json['jamaah'][x]['no_register']}</b></li>`;
            }
            form += `</ul>
                  </td>
                  <td>
                     ${kurs} ${numberFormat(json['total_fee_agen_perpaket'])}
                  </td>
               </tr>`;
   return form;
}
               ...
               form +=    `</select>
                     ...
                     <div class="col-4 pr-0" >
                        <div class="form-group">
                           ...
                           <input type="text" required="" name="nomor_kamar" placeholder="Nomor Kamar" class="form-control form-control-sm" id="nomor_kamar" value="${nomor_kamar}">
                        </div>
                     </div>
...
function kamar_paket(paket_id){
   ...
   var html   =  `<div class="col-6 col-lg-6 my-3 px-0">`;
         ...
         html +=    `<button class="btn btn-default mx-2" type="button" onclick="cetak_daftar_kamar_jamaah(${paket_id})">
                        <i class="fas fa-print"></i> Cetak Daftar Kamar
                     </button>
                  </div>
                     ...
                     <table class="table table-hover">
                        <thead>
                           <tr>
                              ...
                              <th style="width:35%;">Daftar Jamaah</th>
...
function ListDaftarKamarPaket(JSONData){
   ...
   html =  `<tr ${ status_paket == 'tutup' ? 'class="tabletutup"': '' }>
               <td><b>${json["rooms_number"]} <br> ( ${json["hotel_name"]} )</b></td>
...
function ListAllTransPaket(JSONData){
   ...
   var status_paket = $('#status_paket').val();
   var html =  `<tr>
                  <td>${json.nomor_register}<br>
                     ( ${json.metode_pembayaran} )</td>
                  ...
                  <td>`;
               if( json.metode_pembayaran == 'Cash'){
                  html += `<button type="button" class="btn btn-default btn-action" title="Refund Paket"
                  ...
                  html += `<button type="button" class="btn btn-default btn-action"
                              title="Cetak Riwayat Pembayaran dan Skema Cicilan" onClick="PrintCicilanPaket('${json.id}')">
                               <i class="fas fa-print" style="font-size: 11px;"></i>
                           </button>
                           <button type="button" class="btn btn-default btn-action" title="Pembayaran Paket"
                              onClick="PembayaranCicilan('${json.paket_id}','${json.id}', 'allpaket')">
                               <i class="fas fa-money-bill-alt" style="font-size: 11px;"></i>
                           </button>
                           <button type="button" class="btn btn-default btn-action" title="Hapus Transaksi Paket"
                              onClick="deleteTransaksiPaket('${json.paket_id}','${json.id}', 'allpaket')">
...
function form_add_update_trans_paket(JSONData, JSONValue, state, paket_id){
   ...
   var html   =  `<div class="col-lg-12 mt-0 pt-0" >
                  ...
                  html +=    `${inputTextForm('Nama Jamaah', 'nama_jamaah', fullname, '', '<span class="red">*</span>')}
                           ...
                           <div class="col-12 col-lg-3">
                              ${inputTextForm('Pekerjaan', 'pekerjaan', profession_name, 'col-12 col-lg-3', '', '')}
                           </div>
                           <div class="col-12 col-lg-6">
   ...
   if( nomor_identitas != '' ){
      ajax_x_t2(
         baseUrl + "Trans_paket/checkPersonalInfo", function(data) {
            $('#personal_id').remove();
            if( data['error'] !== true ) {
               $('#nama_jamaah').val(data['data']['fullname']);
               $('#jenis_kelamin :selected').val(data['data']['gender']);
               $('#tempat_lahir').val(data['data']['birth_place']);
               $('#tanggal_lahir').val(data['data']['birth_date']);
               $('#alamat').val(data['data']['address']);
               $('#email').val(data['data']['email']);
               if(data['data']['photo'] != '' ){
                  $('#results').html(`<img class="img-fluid" src="${baseUrl}image/personal/${data['data']['photo']}">`);
               }
               $('#formAreas').append(`<input type="hidden" id="personal_id" name="personal_id" value="${data['data']['personal_id']}">`);
            }else{
               if(data['error_msg'] != 'Data personal tidak ditemukan.'){
                  $('#alern_add_jamaah').html(data['error_msg']);
               }else{
                  $('#alern_add_jamaah').html('');
               }
            }
      ...
      $('#nama_jamaah').val('');
      $('#jenis_kelamin :selected').val(0);
      $('#tempat_lahir').val('');
      $('#tanggal_lahir').val('');
      $('#alamat').val('');
      $('#email').val('');
      $('#results').html( `<div class="py-5" style="width:100%;height:100%;background-color: #e6e6e6;">
                              <div class="mx-auto my-4 py-2 text-center" style="font-weight: 700;color: #909090;">HASIL PHOTO</div>
                           </div>`);
      $( "#personal_id" ).remove();
      $('#alern_add_jamaah').html('');
...
function delete_snapshot(){
   ...
   document.getElementById('results').innerHTML =  `<div class="py-5" style="width:100%;height:100%;background-color: #e6e6e6;">
                                                      <div class="mx-auto my-4 py-2 text-center" style="font-weight: 700;color: #909090;">HASIL PHOTO</div>
                                                   </div>`;
...
function ListDaftarTransaksiPaket(JSONData){
   ...
   var html =  `<tr ${ status_paket == 'tutup' ? 'class="tabletutup"': '' }>
               ...
               if( status_paket == 'buka'){
                  if( json.metode_pembayaran == 'Cash'){
                     html += `<button type="button" class="btn btn-default btn-action" title="Refund Paket"
                                 onClick="formRefundTransaksiPaket('${json.paket_id}','${json.id}', 'perpaket')">
                                  <i class="fas fa-undo-alt" style="font-size: 11px;"></i>
                              </button>
                              <button type="button" class="btn btn-default btn-action" title="Pembayaran Paket"
                                 onClick="formPembayaranCash('${json.paket_id}','${json.id}', 'perpaket')">
                                  <i class="fas fa-money-bill-alt" style="font-size: 11px;"></i>
                              </button>
                              <button type="button" class="btn btn-default btn-action" title="Hapus Transaksi Paket"
                     ...
                     html += `<button type="button" class="btn btn-default btn-action"
                              ...
                              <button type="button" class="btn btn-default btn-action" title="Pembayaran Paket"
                                 onClick="PembayaranCicilan('${json.paket_id}','${json.id}', 'perpaket')">
                                  <i class="fas fa-money-bill-alt" style="font-size: 11px;"></i>
                              </button>
                              <button type="button" class="btn btn-default btn-action" title="Hapus Transaksi Paket"
                                 onClick="deleteTransaksiPaket('${json.paket_id}','${json.id}', 'perpaket')">
         ...
         var html   =  `<div class="col-lg-12 mt-0 pt-0" >
                           <form class="py-2" action="${baseUrl }Trans_paket/transaction_paket_process" id="form_utama_big" class="formName" onsubmit="transactionProcess(event)" >
                              ...
                              <div class="row">
                                 ...
                                 <div class="col-12 col-lg-2">
                                    ${simpleSelectForm('Metode Pembayaran', 'metode_pembayaran', JSON.stringify(e['data']['metode_pembayaran']), ' onChange="metodePembayaran()" ', '', 'py-1')}
                                 </div>
                                 <div class="col-12 col-lg-2">
                                 ...
                                 <div class="col-12 col-lg-3 px-2 " >
                                    ${formAddJamaahPaket(JSON.stringify(e['data']['jamaah']))}
                                    ${simpleSelectForm('Agen', 'agen', JSON.stringify(e['data']['agen']), `onChange="get_fee(${paket_id})"`,'', 'py-1')}
                                    <div class="row" id="fee_agen"></div>
                                 </div>
                                 <div class="col-12 col-lg-9 " >
                                    <div class="row">
                                       <div class="col-12 col-lg-6">
                                          ${simpleSelectForm('Leader Tim', 'leader_tim', JSON.stringify(e['data']['jamaah']), ' onChange="filterLeaderTeam()"  ', '', 'py-1')}
                                       </div>
                                       <div class="col-12 col-lg-3">
                                       ...
                                       <div class="col-12 col-lg-3">
                                          ${currencyForm('Diskon', 'diskon', '', 'onKeyup="get_price_transaksi_paket()"')}
                                       </div>
                                       <div class="col-12 col-lg-3">
                                          ${simpleSelectForm('Sumber Biaya', 'sumber_biaya', JSON.stringify(e['data']['sumber_biaya']), ' onChange="sumberBiaya()"  ','', 'py-1')}
                                       </div>
                                       <div class="col-12 col-lg-9">
                                          <div class="row" id="tempSumberPembiayaan">

                                             <div class="col-12 col-lg-4">
                                                ${inputTextForm('Penyetor', 'penyetor', '', 'required', '')}
                                             </div>
                                             <div class="col-12 col-lg-4">
                                                ${inputTextForm('No HP Penyetor', 'hp_penyetor', '',  'required', '')}
                                             </div>
                                             <div class="col-12 col-lg-4">
                                                ${inputTextForm('Alamat Penyetor', 'alamat_penyetor', '', 'required', '')}
                                             </div>
                                          </div>
                                       </div>
                                       <div class="col-12 col-lg-12">
                                          <div class="row" id="tempTransaksiPaket">
                                             <div class="col-12 col-lg-3">
                                                ${inputTextForm('Invoice', 'inv', e['data']['invoice'], 'readonly', '')}
                                             </div>
                                             ${hiddenForm('invoiceID', e['data']['invoice'] )}
                                             <div class="col-12 col-lg-3">
                                                ${inputTextForm('Sudah Dibayar', 'sudahBayar', '', 'readonly', '')}
                                             </div>
                                             <div class="col-12 col-lg-3">
...
function transactionProcess(e){
   ...
   var sumber_biaya = $('#sumber_biaya').val();
   ...
   if($("#paket_id").length != 0) {
      ...
      if( jamaah.length > 0 ){
         ...
         if( leader != 0 ){
            ...
            if( n === false ){
               ...
               error_msg += 'Leader tim harus termasuk jamaah yang dipilih';
            }
         }else{
            error = 1;
            error_msg += error_msg != '' ? '<br>' : '';
            error_msg += 'Silahkan pilih leader tim salah satu dari jamaah.';
         }
      }else{
         error = 1;
         error_msg += error_msg != '' ? '<br>' : '';
      ...
      if( sumber_biaya == 0 ){
         if( $('#penyetor').val() == '' ){
            error = 1;
            error_msg += error_msg != '' ? '<br>' : '';
            error_msg += 'Nama penyetor tidak boleh kosong.';
         }

         if( $('#hp_penyetor').val() == '' ){
            error = 1;
            error_msg += error_msg != '' ? '<br>' : '';
            error_msg += 'Nomor HP penyetor tidak boleh kosong.';
         }

         if( $('#alamat_penyetor').val() == '' ){
            error = 1;
            error_msg += error_msg != '' ? '<br>' : '';
            error_msg += 'Alamat penyetor tidak boleh kosong.';
         }
      }else{
         var penyetor = $('#penyetor :selected').val();
         if( penyetor == 0 ){
            error = 1;
            error_msg += error_msg != '' ? '<br>' : '';
            error_msg += 'Silahkan pilih nama penyetoor jika ingin melanjutkan proses.';
         }
      }
      ...
      if( metode_pembayaran == 0 ){
         ...
         if( pembayaran == ''){
            error = 1;
            error_msg += error_msg != '' ? '<br>' : '';
            error_msg += 'Untuk melanjutkan proses ini, pembayaran tidak boleh kosong.!!!';
         }
      }
   ...
   ajax_x_t2(
      baseUrl + "Trans_paket/getInvoice", function(e) {
            if( metode_pembayaran == 0 ){
               ...
               html += `<div class="col-12 col-lg-3">
                           ${hiddenForm('invoiceID', e['invoice'] )}
                           ${inputTextForm('Invoice', 'invoice', e['invoice'], 'readonly', '')}
                        </div>
                        <div class="col-12 col-lg-1">
                           ${numberForm('Bulan', 'bulan', '')}
                        </div>
                        <div class="col-12 col-lg-3">
                           ${inputDateForm('Tgl Mulai Tagihan', 'tgl_mulai')}
                        </div>
                        <div class="col-12 col-lg-2">
                           ${currencyForm('Dp', 'dp', '', 'onKeyup="get_price_transaksi_paket()"')}
                        </div>
                        <div class="col-12 col-lg-3">
                           ${currencyForm('Sisa Pembayaran', 'sisa', '', 'onKeyup="get_price_transaksi_paket()"')}
                        </div>`;
...
function sumberBiaya(){
   var sumber_biaya = $('#sumber_biaya :selected').val();
   var metode_pembayaran = $('#metode_pembayaran :selected').val();
   var html = '';
   if( sumber_biaya == 1 ){
      if( metode_pembayaran == 1 ){
         frown_alert('Untuk cicilan hanya bisa dilakukan pembayaran dengan tunai!!!');
         $('#sumber_biaya').val('0').trigger('change');
      }else{
         ajax_x_t2(
            baseUrl + "Trans_paket/getPersonalInfoPaket", function(e) {
               html += `<div class="col-12 col-lg-12">
                           ${selectForm('Penyetor', 'penyetor', JSON.stringify(e['data']['listpersonal']), '  ', '', 'py-1')}
                        </div>`;
      ...
      html += `<div class="col-12 col-lg-4">
                  ${inputTextForm('Penyetor', 'penyetor', '', '', '')}
               </div>
               <div class="col-12 col-lg-4">
                  ${inputTextForm('No HP Penyetor', 'hp_penyetor', '', 'required', '')}
               </div>
                     ...
                     form +=    `</tbody>
                           ...
                           <div class="col-4">
                              <div class="form-group  ">
                                 ...
                                 <select class="form-control form-control-sm" id="sumber_biaya" name="sumber_biaya" onChange="getInfoDeposit()">
...
let cardItemPaket = ( JSONdata ) => {
   ...
   return  `<div class="item item-slider">
               <div class="card" style="width: width:12rem;height:23rem;">
                  ...
                  <div class="card-body px-2 py-1">
                     ...
                     <table class=" mt-1 mb-1 details table table-borderless">
                        <tbody>
