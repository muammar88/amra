...
<script type="text/javascript">
      ...
      if( level_akun == 'administrator' ){
         ...
         html += `<div class="col-12">
                     <div class="row px-3">
                        ...
                        <input class="mb-4" type="text" name="kode_perusahaan" placeholder="Kode Perusahaan">
                     </div>
                  </div>
                  <div class="col-12">
                     <div class="row px-3">
                        ...
                        <input class="mb-4" type="text" name="nomor_whatsapp" placeholder="Nomor Whatsapp">
                     </div>
                  </div>`;
      }
      $('#filter').html(html);
   ...
   let loadJQuery = (uRLs) => {
     ...
     for( x in uRL ){
      ...
      script.src = uRL[x]; script.type = 'text/javascript';
   ...
   let FnCk = (fn) => {
      if( eval("typeof " + fn ) === 'function' ) {
         ...
         console.log(fn + ' Function Notfound !!!'); return false;
      }
   }
   // tab navigation
   ...
   let Slider = (activities, JSONdata) => {
      ...
      let feedBack = 	`<div class="col-12">
                  ...
                  for( x in data ){
                     feedBack  += `<div class="carousel-item ${i == 0 ? 'active' : ''}">${data[x]}</div>`;menu
                     i++;
                  }
                  feedBack += `</div>
                           </div>
